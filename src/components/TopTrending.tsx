...
import { Trophy, Play, Pause, HeartHandshake, Eye, Flame, Crown, Music, Sparkles, Share2 } from 'lucide-react';
...
export const TopTrending: React.FC<TopTrendingProps> = ({
  ...
  if (!topMusic || topMusic.length === 0) return null;
